        ...
        <div class="row my-5">
            ...
            <div
                ...
                <div class="mb-3 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <form class="d-flex flex-column justify-content-center align-items-center" method="POST">
                        ...
                        <div class="d-flex">
                            ...
                            <button type="submit" class="btn btn-primary" name="changeAssistType">Choose</button>
                        </div>
                    </form>
                    <?php
                ...
                <form method="POST">
                    ...
                    $sql = $pdo->prepare("SELECT Address_ID FROM application_tbl where Application_ID = :appid");
                    $sql->bindParam(":appid", $appid, PDO::PARAM_INT);
                    $sql->execute();
                    $result = $sql->fetch(PDO::FETCH_ASSOC);
                    $row = sanitize($result);
                    $addid = $row['Address_ID'];
                    $sql = $pdo->prepare("SELECT t1.Fname, t1.Mname, t1.Lname, t1.Birth_Date, t1.Civil_Status, t1.Contact_Number, t2.Email, t4.Reason,
                    ...
                    $sql->bindParam(":userid", $userid, PDO::PARAM_INT);
                    $sql->bindParam(":addid", $addid, PDO::PARAM_INT);
                    $sql->bindParam(":appid", $appid, PDO::PARAM_INT);
                    $sql->execute();
                    $result = $sql->fetch(PDO::FETCH_ASSOC);
                    $row = sanitize($result);
                                ...
                                <div class="col-6">
                                    <div class="mt-3">
                                        ...
                                        <select class="form-select" id="file01" name="file01" required>
                                            ...
                                            <?php } else {
                                                $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                $sql->bindParam(":req", $req1, PDO::PARAM_INT);
                                                $sql->execute();
                                                $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                $row = sanitize($result);
                                                ?>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <select class="form-select" id="file02" name="file02" required>
                                            ...
                                            <?php } else {
                                                $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                $sql->bindParam(":req", $req2, PDO::PARAM_INT);
                                                $sql->execute();
                                                $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                $row = sanitize($result);
                                                ?>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <select class="form-select" id="file03" name="file03" required>
                                            ...
                                            <?php } else {
                                                $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                $sql->bindParam(":req", $req3, PDO::PARAM_INT);
                                                $sql->execute();
                                                $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                $row = sanitize($result);
                                                ?>
                                    ...
                                    <div class="mt-3">
                                        <?php if ($assistancetype === "Food Assistance") { ?>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <?php } else {
                                                    $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                    $sql->bindParam(":req", $req4, PDO::PARAM_INT);
                                                    $sql->execute();
                                                    $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                    $row = sanitize($result);
                                                    ?>
                                    ...
                                    <div class="mt-3">
                                        <?php if ($assistancetype === "Transportation Assistance" || $assistancetype === "Medical Assistance" || $assistancetype === "Burial Assistance") { ?>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <?php } else {
                                                    $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                    $sql->bindParam(":req", $req5, PDO::PARAM_INT);
                                                    $sql->execute();
                                                    $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                    $row = sanitize($result);
                                                    ?>
                                        ...
                                        <div class="mt-3">
                                            <?php if ($assistancetype === "Psychosocial Support") { ?>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <?php } else {
                                                        $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                        $sql->bindParam(":req", $req6, PDO::PARAM_INT);
                                                        $sql->execute();
                                                        $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                        $row = sanitize($result);
                                                        ?>
                                        ...
                                        <div class="mt-3">
                                            <?php if ($assistancetype === "Psychosocial Support") { ?>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <?php } else {
                                                        $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                        $sql->bindParam(":req", $req7, PDO::PARAM_INT);
                                                        $sql->execute();
                                                        $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                        $row = sanitize($result);
                                                        ?>
                                    ...
                                    <?php if ($assistancetype === "Medical Assistance" || $assistancetype === "Burial Assistance") { ?>
                                        <div class="mt-3">
                                            ...
                                            <select class="form-select" id="file08" name="file08" required>
                                                ...
                                                <?php } else {
                                                    $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                    $sql->bindParam(":req", $req8, PDO::PARAM_INT);
                                                    $sql->execute();
                                                    $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                    $row = sanitize($result);
                                                    ?>
                                    ...
                                    <?php if ($assistancetype === "Medical Assistance" || $assistancetype === "Burial Assistance") { ?>
                                        <div class="mt-3">
                                            ...
                                            <select class="form-select" id="file09" name="file09" required>
                                                ...
                                                <?php } else {
                                                    $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                    $sql->bindParam(":req", $req9, PDO::PARAM_INT);
                                                    $sql->execute();
                                                    $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                    $row = sanitize($result);
                                                    ?>
                                    ...
                                    <?php if ($assistancetype === "Medical Assistance" || $assistancetype === "Burial Assistance") { ?>
                                        <div class="mt-3">
                                            ...
                                            <select class="form-select" id="file10" name="file10" required>
                                                ...
                                                <?php } else {
                                                    $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                    $sql->bindParam(":req", $req10, PDO::PARAM_INT);
                                                    $sql->execute();
                                                    $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                    $row = sanitize($result);
                                                    ?>
                                    ...
                                    <?php if ($assistancetype === "Medical Assistance") { ?>
                                        <div class="mt-3">
                                            ...
                                            <select class="form-select" id="file11" name="file11" required>
                                                ...
                                                <?php } else {
                                                    $sql = $pdo->prepare("SELECT Document_Type FROM requirements_tbl where File_ID = :req");
                                                    $sql->bindParam(":req", $req11, PDO::PARAM_INT);
                                                    $sql->execute();
                                                    $result = $sql->fetch(PDO::FETCH_ASSOC);
                                                    $row = sanitize($result);
                                                    ?>
                ...
                <?php if (isset($_POST['applicationForm'])) {
                    ...
                    try {
                        ...
                        $sql->bindParam(':ec', $ec, PDO::PARAM_INT);
                        ...
                        if ($sql->execute()) {
                            ...
                            <script>alert("Your Application has been Edited.")
