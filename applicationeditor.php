                    ...
                    <div class="border border-black rounded shadow p-5">
                        ...
                        <form method="POST">
                            ...
                            $sql = "SELECT t1.Fname, t1.Mname, t1.Lname, t1.Birth_Date, t1.Civil_Status, t1.Contact_Number, t2.Email, t4.Reason,
                                    ...
                                    t4.Edited_Count, t4.Date_Edited,
                            ...
                            $result = mysqli_query($conn, $sql);
                            $row = mysqli_fetch_assoc($result);
                            $req1 = (isset($row['Req1'])) ? htmlspecialchars($row['Req1']) : "";
                            $req2 = (isset($row['Req2'])) ? htmlspecialchars($row['Req2']) : "";
                            $req3 = (isset($row['Req3'])) ? htmlspecialchars($row['Req3']) : "";
                            $req4 = (isset($row['Req4'])) ? htmlspecialchars($row['Req4']) : "";
                            $req5 = (isset($row['Req5'])) ? htmlspecialchars($row['Req5']) : "";
                            $req6 = (isset($row['Req6'])) ? htmlspecialchars($row['Req6']) : "";
                            $req7 = (isset($row['Req7'])) ? htmlspecialchars($row['Req7']) : "";
                            $req8 = (isset($row['Req8'])) ? htmlspecialchars($row['Req8']) : "";
                            $req9 = (isset($row['Req9'])) ? htmlspecialchars($row['Req9']) : "";
                            $req10 = (isset($row['Req10'])) ? htmlspecialchars($row['Req10']) : "";
                            $req18 = (isset($row['Req11'])) ? htmlspecialchars($row['Req11']) : "";
                            $ecou9t = (isset($row['Edited_Count'])) ? $row['Edited_Count'] : "";
                            $edate10 = (isset($row['Date_Edited'])) ? $row['Date_Edited'] : "";
                            ?>
                            <div class="row">
                                <div class="col-3">
                                    <div class="mt-3">
                                        ...
                                        <div class="col-6">
                                            <div class="mt-3">
                                                ...
                                                <select class="form-select" id="file01" name="file01" required>
                                                    ...
                                                    <?php } else {
                                                        $sql = "SELECT Document_Type where";
                                                        ?>
                                                        <option value="<?php echo $req1?>"></option>
                                                    <?php }?>
