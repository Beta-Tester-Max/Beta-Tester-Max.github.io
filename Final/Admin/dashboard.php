    ...
    <div class="modal" id="applicationModal">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div class="application-category">Medical Assistance</div>
            </div>
            <div class="modal-body">
                <p>Reason: I am deeply in debt because my sibling got sick. I have no relatives who can help, all my possessions are gone, my parents have passed away, and I am also currently undergoing intense medical treatment.</p>
            </div>
    ...
    <script>
      ...
      document.querySelectorAll(".application-action").forEach((button) => {
       ...
       // Modal functionality
        ...
        document.querySelectorAll('.application-action').forEach(button => {
            button.addEventListener('click', function() {
                const name = this.parentElement.querySelector('.application-name').textContent.split('\n')[0];
                const category = this.parentElement.querySelector('.application-name').textContent.split('\n')[1];
                
                // Update modal content based on the selected application
                document.querySelector('.applicant-details h3').textContent = name;
                document.querySelector('.applicant-details p').textContent = category;
