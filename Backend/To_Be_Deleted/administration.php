...
if (isset($_SESSION['authority'])) {
    ...
    <body class="overflow-x-hidden" style="min-width: 100%;">
            ...
            <div class="row justify-content-md-center mt-2">
                ...
                if ($m1a) {
                    ...
                    <div class="col border rounded shadow p-3 mx-2 overflow-y-scroll overflow-x-hidden"
                        ...
                        foreach ($data as $users) {
                            $user = $users["User_ID"];
                            $sql = $pdo->prepare("SELECT t1.Fname, t1.Mname, t1.Lname, t2.Street_Address, t2.Barangay, t2.CityorMunicipality, t2.Province
                            FROM userinfo_tbl as t1, address_tbl as t2 
                            ...
                            $Mname = (isset($data['Mname'])) ? $data['Mname'] : '';
                            $Lname = (isset($data['Lname'])) ? $data['Lname'] : '';
                            $streetAddress = (isset($data['Street_Address'])) ? $data['Street_Address'] : '';
                            $barangay = (isset($data['Barangay'])) ? $data['Barangay'] : '';
                            $cityOrMunicipality = (isset($data['CityorMunicipality'])) ? $data['CityorMunicipality'] : '';
                            $province = (isset($data['Province'])) ? $data['Province'] : '';
                            $address = $streetAddress . "&nbsp;" . $barangay . "&nbsp;" . $cityOrMunicipality . "&nbsp;" . $province;
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <form method="POST">
                                                ...
                                                <input type="hidden" name="address" value="<?php echo $address ?>" required>
                                                <input type="hidden" name="showUserDetails" required>
                                                <button class="btn btn-outline-info rounded-pill ms-2" data-bs-dismiss="modal">View
        ...
        if (isset($_POST['showUserDetails'])) {
            ...
            ?>
            <div class="container-fluid <?php echo (isset($_POST['showUserDetails'])) ? "" : "d-none" ?>" id="card"
                style="height: 20em;">
