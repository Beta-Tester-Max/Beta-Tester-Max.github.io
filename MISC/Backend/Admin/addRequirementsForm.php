...
<head>
    ...
    <title>Add Requirements => Assistance</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-md-center my-5">
            <div class="col-md-auto">
                ...
                <form method="POST" action="../Functions/PHP/addRequirements.php">
                    ...
                    <Select name="document" required>
                        ...
                        <?php include "../Functions/PHP/documentsSelect.php"?>
                    </Select>
                    ...
                    <input type="hidden" name="addRequirements" required>
